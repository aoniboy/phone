        ...
        <div class="wrap_box newdh">
            <div class="topfix">
                <div class="top dx tc">
                    ...
                    <div class="fx">
                        <p class="col666">余额</p>
                        <div class="col_red f34"><?=$this->user['coin']?>元</div>
                    </div>
                </div>
                <ul class="toplist">
            ...
            <div class="top_padding">
                <ul class="d_box">
                    ...
                    <li class="d_center">
                        <div class="f30 d_text2"><span class="col_red">[<?=$this->info28['number']?>期]</span>单注<span class="col_red">2元</span>起，<span class="col_red">20000元</span>封顶，总注<span class="col_red">3000000元</span>封顶<br><span class="col_red">★★现状可以开始投注★★</span></div>
                    </li>
                    <li class="d_center">
