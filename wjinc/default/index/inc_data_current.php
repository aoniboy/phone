...
?>
    <div class="bd" id="kaijiang" type="<?=$this->type?>" ctype="<?=$types[$this->type]['type']?>"></div>
     <div class="thisGame">
          <ul>
      ...
      <td class="game_top_period" width='260' >
       ...
       <td class="game_top_aright"> 
	    <div class="kj-bottom"><span class="tit">&nbsp;&nbsp;第 <span class="last_issues"><?=$lastNo['actionNo']?></span> 期  <span id="kjsay">开奖倒计时：<em class="kjtips">00:00</em></span></span><img id="voice" class="voice-on"  title="" onclick="voiceKJ()"><span id="lockgame"></span><div class="clear"></div></div>
 	...
 	<?php }else{  ?>
	    ...
	    <div class="kj-bottom"><span class="tit"><span class='gamename'><?=$types[$this->type]['title']?></span>&nbsp;&nbsp;第 <span class="last_issues"><b><?=$lastNo['actionNo']?></b></span> 期  总共:<b style="color:#FF0000"><?=$types[$this->type]['num']?></b>&nbsp;期  <div class="clear"></div></div>  
