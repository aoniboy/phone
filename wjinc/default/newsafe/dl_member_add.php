                ...
                <ul class="myi_list dla_list">
                    <li class="clearfix rel">
                        ...
                        <div class="fl ol67">
                            ...
                            <?php if ($this->user['parentId']) { ?><label><input name="type" type="radio" value="0" title="会员" style="-webkit-appearance:radio; margin-left: .2rem"> 会员</label><?php } ?>
                        </div>
                    </li>
                    <li class="clearfix">
                    ...
                    <li class="clearfix">
                        ...
                        <input class="col67 fl i6" name="fanDianBdw" max="<?= $this->user['fanDianBdw'] ?>" value=""  ōnkeyup="if(isNaN(value))execCommand(''undo'')" onkeyup="if (isNaN(value))
                    ...
                    <?php if (!$this->user['parentId']) { ?>
                        <li class="clearfix">
                            <div class="fl myw ">域名：</div>
                            <select name="domain" style="width:4rem;background: white;">
                                <?php foreach($this->domainInfo as $value) {?>
